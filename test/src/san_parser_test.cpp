...
TEST_CASE("SAN Parser.Castling", "[san]") {
    CHECK(check_move(parse_san("O-O", Color::White), Piece::WhiteKing, Square::G1, false, std::nullopt, CheckState::None));
    CHECK(check_move(parse_san("O-O", Color::Black), Piece::BlackKing, Square::G8, false, std::nullopt, CheckState::None));
    CHECK(check_move(parse_san("O-O-O", Color::White), Piece::WhiteKing, Square::C1, false, std::nullopt, CheckState::None));
